...
class MLPMixer(nn.Module):
    ...
    2. https://github.com/lucidrains/mlp-mixer-pytorch: Implementation adapted
       from lucidrains mlp-mixer implementation.
    """
    ...
    def __init__(
        ...
        channels_layer = partial(nn.Conv1d, kernel_size=1)
        tokens_layer = nn.Linear
